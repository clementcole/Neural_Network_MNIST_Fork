...
struct Cell{
    double input [NUMBER_OF_INPUT_CELLS]; //28 by 28 = 784 actual input
    double weight[NUMBER_OF_INPUT_CELLS]; //28 by 28 = 784 weights
    double output;	
    double bias;     
};
...
struct Layer{
    Cell cell[NUMBER_OF_OUTPUT_CELLS]; //type = Cell, name = cell, quantity = 10 for 0-9
};
