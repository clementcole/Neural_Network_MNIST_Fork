...
//#define MNIST_TRAINING_SET_IMAGE_FILE_NAME "data/new_data_test/train-images-idx3-ubyte" ///< MNIST image training file in the data folder
//#define MNIST_TRAINING_SET_IMAGE_FILE_NAME "/convert_jpg_png_mnist/JPG-PNG-to-MNIST-NN-Format/test-images-idx3-ubyte"
//#define MNIST_TRAINING_SET_LABEL_FILE_NAME "data/new_data_test/train-labels-idx1-ubyte" ///< MNIST label training file in the data folder
...
//#define MNIST_TESTING_SET_IMAGE_FILE_NAME "data/new_data_test/test-images-idx3-ubyte"
//#define MNIST_TESTING_SET_LABEL_FILE_NAME "data/new_data_test/test-labels-idx1-ubyte"
//#define MNIST_TESTING_SET_LABEL_FILE_NAME "data/t10k-labels-idx1-ubyte"  ///< MNIST label testing file in the data folder
...
MNIST_Image getImage(FILE *imageFile, int train_test);
